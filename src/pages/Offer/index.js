...
export default function Offer() {
    ...
    return (
        <div className={ styles.offer }>
            <Header button="Quero aproveitar essa oferta" buttonPath="/oferta#ofertas" coloredTitle="Você sofre com" title="constipação e região abdominal inchada?" subtitle="Se sim, você está no lugar certo. Nosso combo do Metabolic + Glutamina foi criado pensando exatamente em você." image="./img/OfferPage/bg.png"/>
            <main>
                <Img path="./img/OfferPage/bgImg.png" alt="Imagem de lutadora"/>
                <HeroFlex
                    title="O que é esse combo?"
                    subtitle={["É a união de dois suplementos poderosíssimos. O Metabolic que te fornece energia mental e física e a Glutamina que ajuda a melhorar a saúde intestinal.", "Juntos, eles podem reduzir o inchaço da região abdominal através da diminuição da constipação e podem ainda te fornecer energia, disposição e segurança na hora de vestir aquela roupa!"]}
                    mtop={true}
                />
                <Text 
                    // top={"negative"}
                ...
                <div className={ styles.offerDiv } id="ofertas">
                    <ProductOffer 
                        buttonPath="/oferta/parabens/:1" title="Combo básico" imagePath="./img/OfferPage/product.png"  discount="Ganhe R$89" baloon="Compre e ganhe" fullPrice="DE 403,00" mainPrice="POR 314" desc="Glutamina 300g + 2 potes de Metabolic."
                    />
                    <ProductOffer 
                        buttonPath="/oferta/parabens/:2" title="Combo + Ebook" imagePath="./img/OfferPage/product2.png"  discount="Ganhe R$99" baloon="Compre e ganhe" fullPrice="DE 433,00" mainPrice="POR 334" desc="Glutamina 300g + 2 potes de Metabolic + E-book: como evitar de fato constipação e inchaços."
                    />
                </div>
                <Garantia />
                <Text title="F.A.Q"/>
