    ...
    return (
        <div className={ styles.offer }>
            ...
            <main>
                ...
                <ProductOffer buttonPath="https://seguro.onfirecompany.com.br/r/EW1PPFVLBC" title="Oferta relâmpago" imagePath="./img/OfferPage/product.png"  discount="Ganhe R$89" baloon="Compre e ganhe" fullPrice="DE 403,00" mainPrice="POR 314"/>
            </main>
            <Footer />
        </div>
    )
