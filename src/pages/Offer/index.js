...
export default function Offer() {
    return (
        <div className={ styles.offer }>
            <Header button="Quero aproveitar essa oferta" buttonPath="https://seguro.onfirecompany.com.br/checkout?skipToCheckout=1&tokenReference=EW1PPFVLBC" coloredTitle="Promoção relâmpago:" title="Compre 2 Metabolics e ganhe 1 Glutamina de 300g" subtitle="É bem simples, na compra de dois Metabolic Fire, você ganha uma Glutamina da Integral Médica de 300g gratuitamente!" image="./img/OfferPage/bg.png"/>
            <main>
